...
def compile_contract():
    ...
    temp_file = solcx.compile_files([ROOT_DIR + '/contracts/Incrementer.sol'], output_values=["abi", "bin"])
...
class TestDeployContract(unittest.TestCase):
    ...
    def test_contract_is_deployed(self):
        ...
        deployed = deploy_contract(abi, bytecode, self.web3, self.alice, self.alice_pk)
    ...
    def test_get_incremented_number(self):
        ...
        tx_create = self.web3.eth.account.sign_transaction(increment_tx, self.alice_pk)
